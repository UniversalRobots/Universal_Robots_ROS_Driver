...
void HardwareInterface::read(const ros::Time& time, const ros::Duration& period)
{
  ...
  if (data_pkg)
  {
    ...
    readData(data_pkg, "output_double_register_0", output_double_register_[0]);
    readData(data_pkg, "output_double_register_1", output_double_register_[1]);
    readData(data_pkg, "output_double_register_2", output_double_register_[2]);
    readData(data_pkg, "output_double_register_3", output_double_register_[3]);
    readData(data_pkg, "output_double_register_4", output_double_register_[4]);
    readData(data_pkg, "output_double_register_5", output_double_register_[5]);
